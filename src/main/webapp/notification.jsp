...
<div class="container">
                        ...
                        <div class="col-11">
                            <div class="col-12">
                                <p class="card-text col-11"><span class="font-weight-bold text-dark">
                                        ${tripsPassenger.passenger.firstName} ${tripsPassenger.passenger.lastName} </span>want to join your trip from <span class="font-weight-bold text-dark"> ${tripsPassenger.trip.fromTrip} </span>
                                    to
    ...
    <c:if test="${ratingAsDriver}">
        ...
        <c:forEach var="rateAsDriver" items="${ratingsUserAsDriver}">
            ...
            <button class="list-group-item list-group-item-action" data-toggle="modal" data-target=".ratemodal" action="${pageContext.request.contextPath}/newRating.do?idDriver=${userId}&idPassenger=${rateAsDriver.idPassenger.userId}&idTrip=${rateAsDriver.idTrip.tripId}&isDriver=true"
                    method="post">
                <div class="container">
                    <div class="row">
                        <div class="col-1">
            ...
            <div class="modal fade ratemodal">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <!-- Modal body -->
                        <div class="modal-body">
                            Please rate this passenger from 1 to 5. 1 being a bad passenger and 5 being an excelent passenger.
                            <br>
                        ...
                        <div class="modal-footer">
                            <button onClick="window.location.reload();" type="submit"
                                    class="btn btn-success ratingButtonpassenger"> Rate
                            </button>
                            <a type="button" class="btn btn-secondary" data-dismiss="modal">Close</a>
                        </div>
                    </div>
    ...
    <c:if test="${ratingAsPassenger}">
        ...
        <div class="list-group">
            ...
            <c:forEach var="rateAsPassenger" items="${ratingsUserAsPassenger}">
                ...
                <button class="list-group-item list-group-item-action" data-toggle="modal" data-target=".ratemodaldriver" action="${pageContext.request.contextPath}/newRating.do?idDriver=${rateAsPassenger.idDriver.userId}&idPassenger=${userId}&idTrip=${rateAsPassenger.idTrip.tripId}&isDriver=false"
                        method="post">
                    <div class="container">
                        <div class="row">
                            <div class="col-1">
                ...
                <div class="modal fade ratemodaldriver">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button onClick="window.location.reload();" type="submit"
                                        class="btn btn-success ratingButtondriver"> Rate
                                </button>
                                <a type="button" class="btn btn-secondary" data-dismiss="modal">Close</a>
                            </div>
                        </div>
